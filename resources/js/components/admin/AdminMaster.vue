                    ...
                    <ul class="nav navbar-nav flex-row">
                        ...
                        <li class="nav-item">
                            <a class="navbar-brand" href="index.html">
                                <img class="brand-logo" alt="stack admin logo" :src="'/laravel_vue_ecommerce/public/app-assets/images/logo/stack-logo-light.png'">
                ...
                <div class="navbar-container content">
                    <div class="collapse navbar-collapse" id="navbar-mobile">
                                ...
                                <ul class="mega-dropdown-menu dropdown-menu row">
                                    <li class="col-md-2">
                                        ...
                                        <div id="mega-menu-carousel-example">
                                            <div>
                                                <img class="rounded img-fluid mb-1" :src="'/laravel_vue_ecommerce/public/app-assets/images/slider/slider-2.png'"
                        ...
                        <span class="avatar avatar-sm avatar-online rounded-circle">
                          <img :src="'/laravel_vue_ecommerce/public/app-assets/images/portrait/small/avatar-s-1.png'" alt="avatar"><i></i></span>
                                                </div>
                                                <div class="media-body">
                        ...
                        <span class="avatar avatar-sm avatar-busy rounded-circle">
                          <img :src="'/laravel_vue_ecommerce/public/app-assets/images/portrait/small/avatar-s-2.png'" alt="avatar"><i></i></span>
                                                </div>
                                                <div class="media-body">
                                        ...
                                        <a href="javascript:void(0)">
                                            <div class="media">
                                                <div class="media-left">
                        <span class="avatar avatar-sm avatar-online rounded-circle">
                          <img :src="'/laravel_vue_ecommerce/public/app-assets/images/portrait/small/avatar-s-3.png'" alt="avatar"><i></i></span>
                                                </div>
                                                <div class="media-body">
                        ...
                        <span class="avatar avatar-sm avatar-away rounded-circle">
                          <img :src="'/laravel_vue_ecommerce/public/app-assets/images/portrait/small/avatar-s-6.png'" alt="avatar"><i></i></span>
                                                </div>
                                                <div class="media-body">
                ...
                <ul class="nav navbar-nav" id="main-menu-navigation" data-menu="menu-navigation">
                    <li class="dropdown nav-item" data-menu="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li class="active" data-menu=""><a class="dropdown-item" href="dashboard-ecommerce.html" data-toggle="dropdown">eCommerce
